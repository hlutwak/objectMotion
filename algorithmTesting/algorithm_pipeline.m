...
[velocity_field, dots_deg, dev1, dots_m, dots_m_next,z0, gazeRotation] = get_velocity_field_frames(translation, depth_structure, devPos, displacement,view_dist);
...
d = 1-d;
c = repmat(d', 1,3);
figure, scatter(dots_deg(1,:), -dots_deg(2,:),[],c, 'filled') 
