function  [velocity_field, dots_deg, dev1, dots_m,dots_m_next,z0, gazeRotation]= get_velocity_field_frames(translate, depth_structure, devPos, displacement, view_dist)
if nargin==0
